namespace PartManagerPlugin
{
    partial class PartManagerUI
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ClosePartWindowsButton = new System.Windows.Forms.Button();
			...
			this.groupBox2.Controls.Add(this.ClosePartWindowsButton);
			...
			this.PartsGridView.CellMouseDoubleClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(this.PartsGridView_CellMouseDoubleClick);
			...
			this.PartsGridView.KeyUp += new System.Windows.Forms.KeyEventHandler(this.PartsGridView_KeyUp);
			// 
			// EnabledColumn
			// 
			this.EnabledColumn.FalseValue = "F";
			this.EnabledColumn.HeaderText = "Enabled";
			this.EnabledColumn.Name = "EnabledColumn";
			this.EnabledColumn.TrueValue = "T";
			...
			// 
			// ClosePartWindowsButton
			// 
			this.ClosePartWindowsButton.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.ClosePartWindowsButton.AutoSize = true;
			this.ClosePartWindowsButton.Location = new System.Drawing.Point(168, 464);
			this.ClosePartWindowsButton.Name = "ClosePartWindowsButton";
			this.ClosePartWindowsButton.Size = new System.Drawing.Size(112, 23);
			this.ClosePartWindowsButton.TabIndex = 10;
			this.ClosePartWindowsButton.Text = "Close Part Windows";
			this.ClosePartWindowsButton.UseVisualStyleBackColor = true;
			this.ClosePartWindowsButton.Click += new System.EventHandler(this.ClosePartWindowsButton_Click);
			// 
			// PartManagerUI
			// 
		...
		private System.Windows.Forms.Button ClosePartWindowsButton;
    }
}
